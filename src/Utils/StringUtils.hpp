 ...
 */
template <typename T>
T from_string_or_default(const std::string &str, const T &default_value) {
    T result;
 ...
 */
inline std::string pad_left(const std::string &str, size_t length,
                            char pad_char = ' ') {
 ...
 */
inline std::string pad_right(const std::string &str, size_t length,
                             char pad_char = ' ') {
    if (str.length() >= length) {
        return str;
    }
 ...
 */
template <typename T>
std::string format(const std::string &format_str, const T &value) {
    std::ostringstream oss;
    oss << value;
 ...
 */
inline size_t count_occurrences(const std::string &str,
