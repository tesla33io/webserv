...
public:
  ...
  Logger(const std::string &filename = "", LogLevel minLogLevel = INFO,
         bool enableConsole = true)
      : minLevel(minLogLevel), consoleOutput(enableConsole), fileOutput(false),
  ...
  void logWithPrefix(LogLevel level, const std::string &prefix,
